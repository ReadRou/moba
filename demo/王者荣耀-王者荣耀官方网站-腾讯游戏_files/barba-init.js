...
TGBarba.init({
  index: {
    ...
    onEnter: function () {
      ...
      // getScript('../ossweb-img/utf8/index.min.js', function () {
      getScript('//game.gtimg.cn/images/yxzj/m/m201706/utf8/index.min.js', function () {
  ...
  strategycenter: {
    ...
    onEnter: function () {
      ...
      // getScript('../ossweb-img/utf8/strategycenter.min.js', function () {
      getScript('//game.gtimg.cn/images/yxzj/m/m201706/utf8/strategycenter.min.js', function () {
        $('#search').val('');
